...
dataset = pd.read_csv(
    r'D:/VS Code/Workspace/Machine-Learning--Self-taught-/Random_Forrest_Classifier/Social_Network_Ads.csv')
...
# Training RandomForestClassifier on Training set
classifier = RandomForestClassifier(
    n_estimators=10, criterion='entropy', random_state=0)
classifier.fit(x_train, y_train)

# Predict a new result
print(classifier.predict(standard_scaler.transform([[30, 87000]])))
...
# Visualise the training set reults
